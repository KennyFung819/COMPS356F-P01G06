...
<br>
		<div id="fh5co-about" data-section="about">
			...
			<div class="fh5co-1col fh5co-text">
				<h2 class="heading to-animate">Privacy Policy</h2>
				<p class="to-animate"><span class="firstcharacter">C</span>ellfish ("us", "we", or "our") operates the cellfish.com website (the
"Service"). <br><br>

This page informs you of our policies regarding the collection, use and
disclosure of Personal Information when you use our Service.<br><br>
...
Conditions, accessible at cellfish.com<br><br>
...
name ("Personal Information").<br><br>
...
those pages and other statistics.<br><br>
...
on your computer's hard drive.<br><br>
...
delete such information from our servers immediately.<br><br>
...
<p><a href="contactUs.html" class="btn btn-primary btn-outline">Contact Us</a></p>
			</div>
		</div>
	<div id="fh5co-footer">
		<div class="container">
